...
import net.mcreator.paladium.item.SmeltModifierItem;
...
import net.mcreator.paladium.item.MoreUpgradeModifierItem;
import net.mcreator.paladium.item.KnockbackModifierItem;
...
import net.mcreator.paladium.item.FortuneModifierItem;
import net.mcreator.paladium.item.FlameModifierItem;
...
import net.mcreator.paladium.item.DamageModifierItem;
import net.mcreator.paladium.item.AutoRepairModifierItem;
...
public class PaladiumModItems {
	...
	public static final RegistryObject<Item> MORE_UPGRADE_MODIFIER = REGISTRY.register("more_upgrade_modifier", () -> new MoreUpgradeModifierItem());
