package net.mcreator.paladium.block.entity;
...
public class PaladiumFurnaceBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public PaladiumFurnaceBlockEntity(BlockPos position, BlockState state) {
		super(PaladiumModBlockEntities.PALADIUM_FURNACE.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("paladium_furnace");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new PaladiumFurnaceGuiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
