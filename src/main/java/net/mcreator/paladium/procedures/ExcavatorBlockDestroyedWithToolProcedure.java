...
public class ExcavatorBlockDestroyedWithToolProcedure {
		...
		if (y <= entity.getY() || entity.getXRot() <= -42.5) {
			for (int index0 = 0; index0 < 3; index0++) {
				for (int index1 = 0; index1 < 3; index1++) {
					if ((world.getBlockState(BlockPos.containing(CoosX, y, CoosZ))).is(BlockTags.create(new ResourceLocation("mineable/shovel")))) {
						{
			...
			for (int index2 = 0; index2 < 3; index2++) {
				for (int index3 = 0; index3 < 3; index3++) {
					if ((world.getBlockState(BlockPos.containing(CoosX, coosY, z))).is(BlockTags.create(new ResourceLocation("mineable/shovel")))) {
						{
			...
			for (int index4 = 0; index4 < 3; index4++) {
				for (int index5 = 0; index5 < 3; index5++) {
					if ((world.getBlockState(BlockPos.containing(x, coosY, CoosZ))).is(BlockTags.create(new ResourceLocation("mineable/shovel")))) {
						{
